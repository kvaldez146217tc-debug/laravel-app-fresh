<x-layout title="Add New Book | Book Management System">
        ...
        <div class="bg-white/5 border border-white/10 backdrop-blur-md rounded-3xl p-8 shadow-2xl">
            <form method="POST" action="/books" enctype="multipart/form-data">
                ...
                <div class="border-b border-white/10 pb-8 mb-8">
                    ...
                    <p class="mt-2 text-blue-200/60 text-sm">Fill in the details below to add a new book to the database.</p>
                </div>
                ...
                <div class="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    ...
                    <div class="sm:col-span-3">
                        ...
                        <select id="genre" name="genre" required
                            class="block w-full rounded-xl bg-white/10 border border-white/10 px-4 py-2.5 text-white focus:ring-2 focus:ring-amber-400 focus:border-transparent outline-hidden transition-all sm:text-sm">
                ...
                <div class="mt-12 flex items-center justify-end gap-x-4 pt-8 border-t border-white/10">
                    <a href="/books" class="px-6 py-2.5 text-sm font-bold text-white hover:text-red-400 transition-colors">
                        Cancel
                    </a>
                    <button type="submit"
